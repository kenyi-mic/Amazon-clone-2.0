...
const footer = () => {
  ...
  return (
    <div className="bg-amazon_blue ">
     <h3 className="link hover:underline-none p-4 bg-amazon_blue-light text-white text-sm grid grid-cols-1 text-bold place-items-center"> Back to top</h3>
      ...
      <p className="link text-gray-400">> See More Make Money <br/> with Us</p>
      ...
      <p className="link text-gray-400">Amazon and <br/> COVID-19</p>
      <p className="link text-gray-400">Your Account</p>
      <p className="link text-gray-400">Your Orders</p>
      <p className="link text-gray-400">Shipping Rates & <br/> Polices</p>
      <p className="link text-gray-400">Return & <br/> Replacements</p>
      <p className="link text-gray-400">Manage Your <br/> Content and Devices</p>
      ...
      <p className="grid grid-cols-1 p-5  place-items-center"><Image
          onClick={() =>router.push('/')}
          ...
          /></p>
      <p  onClick={! session ? signIn : signOut} className=" text-white grid grid-cols-1 link  place-items-center p-5 text-bold hover:text-gray-500">Sign Up
